...
public:
   ...
   virtual std::string getPseudocode()
   {
      ...
      str += "   IF initializationStarted == False\n";
...
private:
   ...
   void initialize(uint32_t password)
   {
      ...
      // Initialize P and S-Boxes with pi? I couldn't find anyway to do this online. So this will not work unless I put them all in by hand.
      // Numbers came from https://www.geeksforgeeks.org/blowfish-algorithm-with-examples/ because I couldn't find any other way.
      P[0] = 0x243f6a88;
      P[1] = 0x85a308d3;
      P[2] = 0x13198a2e;
      P[3] = 0x03707344;
      ...
      P[16] = 0x9216d5d9;
      P[17] = 0x8979fb1b;
      uint32_t init[4][256] = {{ 0xd1310ba6,  0x98dfb5ac,  0x2ffd72db,  0xd01adfb7,  0xb8e1afed,  0x6a267e96,  0xba7c9045,  0xf12c7f99,  
      ...
      // Now we can continue with the normal algorithm
      for (int i=0 ; i<18 ; ++i)
